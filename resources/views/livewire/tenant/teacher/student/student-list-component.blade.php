        ...
        @if($hasFilter)
            ...
            <div class="card-header border-0">
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('teacher.student.add', ['tenant' => tenant('id')]) }}" class="btn-outline bg-dark text-white">
                            ...
                            <tr>
                                ...
                                <td class="no-print">
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('teacher.student.overview', ['tenant' => tenant('id'), 'id' => $student->id]) }}" target="_blank"
                                            class="act-btn view" title="View">
                                            <span class="material-icons-round">visibility</span>
                                        </a>
                                        <a href="{{ route('teacher.student.edit', ['tenant' => tenant('id'), 'id' => $student->id]) }}"
