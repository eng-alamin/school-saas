<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('teacher.student.overview') ? 'active' : '' }}" href="{{ route('teacher.student.overview', ['tenant' => tenant('id'), 'id' => $student->id]) }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('teacher.student.invoice') ? 'active' : '' }}" href="{{ route('teacher.student.invoice', ['tenant' => tenant('id'), 'id' => $student->id]) }}">Invoice</a></li>
        <li wire:ignore class="nav-item"><a class="nav-link {{ request()->routeIs('teacher.student.payment.add') ? 'active' : '' }}" href="{{ route('teacher.student.payment.add', ['tenant' => tenant('id'), 'id' => $student->id]) }}">Payment</a></li>
