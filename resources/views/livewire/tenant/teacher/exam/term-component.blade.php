<div>
    ...
    <div class="card">
      ...
      <div class="mat-card-header header-pink-gradient">
        <h5 id="cardHeaderTitleAllsections">Exam Term</h5>
        <p id="cardHeaderSubtitle">Manage exam terms, create, update, and organize academic terms easily.</p>
      </div>
        ...
        <div class="card-header border-0">
            ...
            <div class="card-toolbar">
                ...
                <button class="btn-outline bg-dark text-white" wire:click="openCreate">
                    <span class="material-icons-round">add</span> <span id="newSectionBtn">Add Term</span>
                </button>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <button class="act-btn edit" title="Edit" wire:click="openEdit({{ $term->id }})">
                                        <span class="material-icons-round">drive_file_rename_outline</span>
                                    </button>
                                    <button class="act-btn delete" title="Delete" wire:click="confirmDeleteRecord({{ $term->id }})">
                        ...
                        <tr>
                            <td colspan="8" class="text-center py-5 text-muted">
                                ...
                                No terms found. <a href="#" wire:click.prevent="openCreate">Create one now</a>.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="card-footer border-0 bg-white d-flex align-items-center justify-content-between flex-wrap gap-2 py-2 px-3">
            <small class="text-muted">Showing {{ $terms->firstItem() ?? 0 }}–{{ $terms->lastItem() ?? 0 }} of {{ $terms->total() }}</small>
           {{ $terms->links('vendor.pagination.custom') }}
        </div>
                        ...
                        <form wire:submit.prevent="save">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" wire:model.defer="name" placeholder="e.g. Term One">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body text-center py-4">
                        ...
                        <h6 class="fw-700">Delete Term?</h6>
