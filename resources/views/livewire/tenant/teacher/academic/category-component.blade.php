    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('teacher.academic.sections', ['tenant' => tenant('id')]) }}" class="btn-outline">
                    <span class="material-icons-round" style="font-size:16px">border_inner</span><span>Section</span>
                </a>
                <a href="{{ route('teacher.academic.categories', ['tenant' => tenant('id')]) }}" class="btn-outline bg-dark text-white">
