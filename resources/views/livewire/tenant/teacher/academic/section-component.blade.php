<div>
    ...
    <div class="card">
        ...
        <div class="mat-card-header header-pink-gradient">
            <h5 id="cardHeaderTitleAllsections">All Sections</h5>
            <p id="cardHeaderSubtitle">Manage sections, create, update, and organize easily.</p>
        </div>
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('teacher.academic.classes', ['tenant' => tenant('id')]) }}" class="btn-outline">
                    <span class="material-icons-round" style="font-size:16px">flight_class</span><span>Class</span>
                </a>
                <a href="{{ route('teacher.academic.sections', ['tenant' => tenant('id')]) }}" class="btn-outline bg-dark text-white">
                    <span class="material-icons-round" style="font-size:16px">border_inner</span><span>Section</span>
                </a>
                <a href="{{ route('teacher.academic.categories', ['tenant' => tenant('id')]) }}" class="btn-outline">
                ...
                <button class="btn-outline bg-dark text-white" wire:click="openCreate">
                    <span class="material-icons-round">add</span> <span>New Section</span>
                </button>
            </div>
        </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th wire:click="sortBy('capacity')" style="cursor:pointer">
                                Capacity @if($sortField === 'capacity') {!! $sortDirection === 'asc' ? '↑' : '↓' !!} @endif
                            </th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <button class="act-btn delete" title="Delete" wire:click="confirmDeleteRecord({{ $section->id }})">
                        ...
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted">
                                ...
                                No sections found. <a href="#" wire:click.prevent="openCreate">Create one now</a>.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
        ...
        <div class="card-footer border-0 bg-white d-flex align-items-center justify-content-between flex-wrap gap-2 py-2 px-3">
            <small class="text-muted">Showing {{ $sections->firstItem() ?? 0 }}–{{ $sections->lastItem() ?? 0 }} of {{ $sections->total() }}</small>
            ...
            <div class="modal-dialog modal-md modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header border-0">
                        <h5 class="modal-title">{{ $editId ? 'Edit' : 'Create' }} Section</h5>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body text-center py-4">
                        ...
                        <h6 class="fw-700">Delete Section?</h6>
