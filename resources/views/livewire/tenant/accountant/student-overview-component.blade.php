<div class="mat-card" style="padding-top:28px">
    ...
    <div class="container-xl mt-4">
        ...
        @include('livewire.tenant.accountant.student-navbar', ['student' => $student])
        ...
        <div class="footer-actions">
            <a href="{{ route('accountant.student.edit', ['tenant' => tenant('id'), 'id' => $student->id]) }}" class="btn btn-ghost">
