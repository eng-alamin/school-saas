<div>
    ...
    <div class="card">
      ...
      <div class="mat-card-header header-pink-gradient">
        <h5 id="cardHeaderTitleAllsections">Fee Type</h5>
        <p id="cardHeaderSubtitle">Manage fee types, create, update, and organize student fee categories easily.</p>
      </div>
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <button class="btn-outline bg-dark text-white" wire:click="openCreate">
                    <span class="material-icons-round">add</span> <span id="newSectionBtn">Add Fee Type</span>
                </button>
            </div>
        </div>
                ...
                <table class="table table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th wire:click="sortBy('fee_code')" style="cursor:pointer">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                No fee types found. <a href="#" wire:click.prevent="openCreate">Create one now</a>.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body text-center py-4">
                        ...
                        <h6 class="fw-700">Delete Fee Type?</h6>
