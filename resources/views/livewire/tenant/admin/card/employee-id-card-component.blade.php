                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        @if($employee->logo_path)
                                            <img src="{{ asset($employee->logo_path) }}" class="avatar" alt="">
                                        @else
                            ...
                            <div style="padding:12px 14px;display:flex;gap:10px;">
                                ...
                                <div style="flex:1;min-width:0;">
                                    ...
                                    <table style="font-size:.68rem;width:100%;border-collapse:collapse;color:{{ $tmpl?->text_color ?? '#000' }};">
                                        ...
                                        <tr>
                                            <td style="color:rgba(0,0,0,.5);padding:1px 0;width:45%;">Designation:</td>
                                            <td style="font-weight:500;">{{ $card['designation'] }}</td>
                                        </tr>
                                        @endif
