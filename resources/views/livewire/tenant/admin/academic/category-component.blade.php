<div class="mat-card" style="padding-top:28px">
      ...
      <div class="table-card">
        ...
        <div class="card-toolbar">
          ...
          <a href="{{ route('tenant.academic.categories') }}" class="btn-outline bg-dark text-white">
          ...
          <button class="btn-outline" data-bs-toggle="modal" data-bs-target="#openCreateModal">
            <span class="material-icons-round">add</span> <span id="newCategoryBtn">New Category</span>
          </button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer border-0">
                    <button class="btn-outline" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" wire:click="update({{ $category_id }})" class="btn-pink">Update</button>
                </div>
...
@push('scripts')
    <script>
        ...
        document.getElementById('tableSearch').addEventListener('input', function() {
            ...
            filteredData = categories.filter(p =>
        ...
        function confirmDelete() {
            ...
            const idx = categories.findIndex(x => x.id === deleteTargetId);
            if (idx > -1) {
        ...
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('refresh-list', (data) => {
                ...
                categories.length = 0;
                newData.forEach(d => categories.push(d));
                filteredData = [...categories];
                renderTable();
