        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-4" style="display:flex;flex-direction:column;gap:14px">
                    ...
                    <input type="hidden" wire:model="designation_id"/>
                ...
                <div class="modal-footer border-0">
                    <button class="btn-outline" data-bs-dismiss="modal">Cancel</button>
                    <button type="button" wire:click="update({{ $designation_id }})" class="btn-pink">Update</button>
                </div>
...
@push('scripts')
    <script>
        ...
        document.getElementById('tableSearch').addEventListener('input', function() {
            ...
            filteredData = designations.filter(p =>
        ...
        function openDeleteModal(id) {
            deleteTargetId = id;
            const p = designations.find(x => x.id === id);
            if (!p) return;
        ...
        function confirmDelete() {
            ...
            const idx = designations.findIndex(x => x.id === deleteTargetId);
            if (idx > -1) {
                designations.splice(idx, 1);
                filteredData = [...designations];
                renderTable();
            }
        ...
        document.addEventListener('livewire:initialized', () => {
            Livewire.on('refresh-list', (data) => {
                ...
                newData.forEach(d => designations.push(d));
                filteredData = [...designations];
                renderTable();
