<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.parent.overview') ? 'active' : '' }}" href="{{ route('admin.parent.overview', ['tenant' => tenant('id'), 'id' => $parent->id]) }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.parent.child') ? 'active' : '' }}" href="{{ route('admin.parent.child', ['tenant' => tenant('id'), 'id' => $parent->id]) }}">Children</a></li>
