<div class="card-custom profile-card p-4 mb-4">
    ...
    <ul class="nav profile-tabs border-bottom mt-4 flex-nowrap overflow-auto">
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.profile.overview') ? 'active' : '' }}" href="{{ route('admin.profile.overview', ['tenant' => tenant('id')]) }}">Overview</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.profile.setting') ? 'active' : '' }}" href="{{ route('admin.profile.setting', ['tenant' => tenant('id')]) }}">Settings</a></li>
        <li class="nav-item"><a class="nav-link {{ request()->routeIs('admin.profile.activity') ? 'active' : '' }}" href="{{ route('admin.profile.activity', ['tenant' => tenant('id')]) }}">Activity</a></li>
    </ul>
</div>