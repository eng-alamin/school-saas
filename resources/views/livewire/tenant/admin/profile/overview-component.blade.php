<div>
    <div class="card">
        ...
        <div class="container-xl mt-4">
            ...
            @include('livewire.tenant.admin.profile.navbar', ['user' => $user])
            ...
            <div class="card-custom profile-card p-4 mb-4">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                    ...
                    <a href="{{ route('admin.profile.setting', ['tenant' => tenant('id'), 'id' => $user->id]) }}" class="btn-outline bg-dark text-white">
                        Edit Profile
                    </a>
                </div>
