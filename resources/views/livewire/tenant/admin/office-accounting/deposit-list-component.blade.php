    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{route('admin.office-accounting.deposit.add', ['tenant' => tenant('id')]) }}" class="btn-sm btn-outline bg-dark text-white">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('admin.office-accounting.deposit.edit', ['tenant' => tenant('id'), 'id' => $deposit->id]) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="9" class="text-center py-5 text-muted">
                                    ...
                                    No deposits found.
                                    <a href="{{ route('admin.office-accounting.deposit.add', ['tenant' => tenant('id')]) }}">Create one now</a>.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
