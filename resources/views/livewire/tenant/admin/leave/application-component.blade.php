    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.leave.categories', ['tenant' => tenant('id')]) }}" target="_blank" class="btn-sm btn-outline bg-dark text-white" wire:click="openCreate">
                    <span class="material-icons-round">add</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    {{-- Edit --}}
                                    <button class="act-btn edit" title="Edit" wire:click="openEdit({{ $app->id }})">
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                @elseif($document_path)
                                    <small class="text-muted mt-1 d-block">
                                        <span class="material-icons-round" style="font-size:13px;vertical-align:middle">attach_file</span>
                                        Existing attachment
                                        <a href="{{ asset('storage/'.$document_path) }}" target="_blank" class="ms-1">View</a>
                                    </small>
                                @endif
            ...
            <div class="modal-dialog modal-md modal-dialog-scrollable">
                <div class="modal-content">
                        ...
                        <table class="table table-borderless mb-0" style="font-size:.875rem;">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 align-items-center flex-wrap">
                                            @foreach(['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Reject'] as $val => $label)
                                                <label class="d-flex align-items-center gap-1" style="cursor:pointer;font-size:.85rem;">
                                                    <input type="radio" wire:model="status" value="{{ $val }}" style="cursor:pointer">
                                                    {{ $label }}
                                                </label>
                                            @endforeach
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea class="form-control form-control-sm" wire:model="comments"
                                                  rows="3" placeholder="Add review comments..."></textarea>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="modal-footer border-0">
                        ...
                        <button type="button" class="btn bg-dark text-white btn-sm" wire:click="saveDetail" wire:loading.attr="disabled">
                            <span wire:loading wire:target="saveDetail" class="spinner-border spinner-border-sm me-1"></span>
                            <span class="material-icons-round me-1" style="font-size:.9rem;vertical-align:middle">add_circle_outline</span>
                            Apply
                        </button>
                    </div>
