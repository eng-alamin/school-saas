    ...
    <div class="card">
        ...
        <div class="card-header border-0">
            <div class="card-toolbar">
                ...
                <a href="{{ route('admin.salary.add-template', ['tenant' => tenant('id')]) }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <a href="{{ route('admin.salary.edit-template', ['tenant' => tenant('id'), 'id' => $template->id]) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5 text-muted">
                                    ...
                                    <a href="{{ route('admin.salary.add-template', ['tenant' => tenant('id')]) }}">Create one now</a>.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
