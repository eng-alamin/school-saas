...
namespace App\Livewire\Tenant\Admin\OfficeAccounting;
...
class ExpenseAddComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.tenant.admin.office-accounting.expense-add-component')
            ->with('accounts', $accounts)
            ->with('heads', $heads)
            ->layout('layouts.tenant.app', [
                'title' => 'Add Expense | Monarchy School',
            ]);
    }
}